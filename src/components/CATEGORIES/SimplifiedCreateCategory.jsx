...
import { useCategoryContext } from '../../contexts/CategoryContext' // Importez useCategoryContext
import CategoryTreeSelect from './CategoryTreeSelect'
import { transformCategoriesToTree } from '../../utils/transformCategoriesToTree'
import CloseIcon from '@mui/icons-material/Close'
import AddIcon from '@mui/icons-material/Add'

function SimplifiedCreateCategory() {
  const {
    register,
    handleSubmit,
    reset,
  ...
  const { categories, addCategoryToContext } = useCategoryContext() // Utilisez useCategoryContext ici
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await addCategoryToContext(categoryData) // Utilisez addCategoryToContext pour ajouter une catégorie
      reset()
      setSelectedParentId('')
      setSelectedParentName('')
      setCategoryName('')
...
export default SimplifiedCreateCategory
